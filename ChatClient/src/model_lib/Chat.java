...
//    private String user;
    ...
    @Override
    public void printMyMessage(IMessage msg)
    {
        listener.printMineToScreen(msg, port);
    }

    @Override
    public void popThePopup(String text) throws IOException, InterruptedException {
        listener.showPopup(text);
    }
